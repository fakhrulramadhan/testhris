...
WebUI.click(findTestObject('Jobs/Jobs Delete/Page_OrangeHRM/button_Account Assistant_oxd-icon-button oxd-table-cell-action-space'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('JobDelete/Page_OrangeHRM/button_Yes, Delete'))
