...
WebUI.click(findTestObject('Page_OrangeHRM/Page_OrangeHRM/div_-- Select --'))

WebUI.click(findTestObject('Jobs/Jobs Add/Page_OrangeHRM/div_Disabled'))

WebUI.setText(findTestObject('Option/Page_OrangeHRM/Page_OrangeHRM/input/input_Password_oxd-input oxd-input--active'), 'aihsisII82*(')

WebUI.setText(findTestObject('Option/Page_OrangeHRM/Page_OrangeHRM/input/input_employee'), 'ha')

WebUI.delay(3)

WebUI.click(findTestObject('Option/Page_OrangeHRM/Page_OrangeHRM/input/Page_OrangeHRM/div_Charlie  Carter'))
