...
WebUI.click(findTestObject('Edit-User-Management/Admin_Delete/Page_OrangeHRM/i_Enabled_oxd-icon bi-trash'))

WebUI.click(findTestObject('Edit-User-Management/Admin_Delete/Page_OrangeHRM/button_Yes, Delete'))
