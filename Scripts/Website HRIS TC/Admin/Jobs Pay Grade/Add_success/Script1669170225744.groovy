...
WebUI.click(findTestObject('Jobs Pay Grade/Add/Page_OrangeHRM/button_Add'))

WebUI.setText(findTestObject('Jobs Pay Grade/Add/Page_OrangeHRM/input_Name_oxd-input oxd-input--active'), 'Poundsterling Grades')

WebUI.click(findTestObject('Jobs Pay Grade/Add/Page_OrangeHRM/button_Save'))
