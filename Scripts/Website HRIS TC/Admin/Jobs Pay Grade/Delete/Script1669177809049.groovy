...
WebUI.click(findTestObject('Jobs Pay Grade/Delete/Page_OrangeHRM/button_United States Dollar_oxd-icon-button oxd-table-cell-action-space'))

WebUI.click(findTestObject('Jobs/Jobs Delete/btndel/Page_OrangeHRM/button_Yes, Delete (1)'))
